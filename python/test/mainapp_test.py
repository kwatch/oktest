...
Traceback (most recent call last):
  ...
  File "_test.d/_sos_test.py", line 28, in _
    fail("msg")
  File "/usr/local/lib/python/site-packages/oktest.py", line 945, in fail
...
Traceback (most recent call last):
  File "/usr/local/lib/python/unittest.py", line 254, in run
    testMethod()
  File "/usr/local/lib/python/site-packages/oktest.py", line 2415, in newfunc
    return orig_func(self)
  File "/usr/local/lib/python/site-packages/oktest.py", line 1036, in deco
